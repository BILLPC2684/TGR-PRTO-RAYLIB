...
if gcc src/main.c -o TGR.exe -I./src/include -I./bin/raylib/src -I./bin/raylib/src/external -I./bin/raylib/src/external/glfw/include -L./bin/raylib/src -L./bin ./bin/for-windows.rc.data -I./bin/cJSON -L./bin/cJSON -mwin32 -lraylib -lopengl32 -lgdi32 -lwinmm -DPLATFORM_DESKTOP -lcjson -lm -lpthread -g ./netlib.dll; then
