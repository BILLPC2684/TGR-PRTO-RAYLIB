#!/bin/bash
if gcc src/main.c -o TGR -pg -I./src/include -lraylib -lcjson -lGL -lm -lpthread -ldl -lrt -lX11 -g -I./bin/raylib/src/ /usr/lib/libnetlib.so -Wformat-overflow=0 --debug; then
