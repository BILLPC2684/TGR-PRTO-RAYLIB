; windows (run): https://github.com/hlorenzi/customasm/releases/download/v0.13.4/customasm_win64.zip
; linux (cargo build): https://github.com/hlorenzi/customasm/archive/refs/tags/v0.13.4.zip
A = 0
B = 1
C = 2
D = 3
...
#ruledef taylor {
 HEADER0 => 0`8 @ "TGR" @ 0`8 @ "==[REPLACE ME]==v00.00.00   " @ 0xFF`8
 HEADER1 => 1`8 @ "TGR" @ 0`8 @ "==[REPLACE ME]==v00.00.00   [---======[REPLACE ME]======---]" @ 0xFF`8
 HEADER2 => 2`8 @ "TGR" @ 0`8 @ "==[REPLACE ME]==v00.00.00   [---======[REPLACE ME]======---][---======[REPLACE ME]======---]" @ 0xFF`8
 
 lload {A}, {B}, {IMM} => 0x00 @ A`4 @ 0`8 @ (IMM>>16)`28 @ 0x00 @ B`4 @ 0`8 @ (IMM&0xFFFF)`28
 ...
 clk {A},{B},{RESET} => 0x20 @ A`4 @ B`8 @ 0`27 @ RESET`1
 
 wait  {A}   => 0x21 @ A`4 @ 0`36
 waiti {IMM} => 0x21 @ 0`4 @ IMM`36

 break {IMM} => 0x22 @ 0`12 @ IMM`28
